...
public class ConditionalExamples {
	 ...
	 */
	public static double computedCubed(double a) {
		return a*a*a;
	}
	...
	public static void guessCubeRoot(double number, double guess) {
		double c = guess*guess*guess;
		if (c > number){
			System.out.println("The cube root of " + number + " compared to " + guess + " is Lower");
		}else if(c == number){
			System.out.println("The cube root of " + number + " compared to " + guess + " is Perfect");
		}else if (c < number){
			System.out.println("The cube root of " + number + " compared to " + guess + " is Higher");
		}
	}
	...
	public static void main(String[] args) {
		...
		System.out.println("The cube of 3 is " + computedCubed(3));
		guessCubeRoot(27, 4);
